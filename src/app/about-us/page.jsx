...
function AboutUs() {
  return (
    <div>
      <section className="relative bg-[url(https://img.freepik.com/free-photo/confident-smiling-doctor-woman-physician-showing-thumbs-up-holding-clipboard-appointment-hospital_1258-124596.jpg?t=st=1737808220~exp=1737811820~hmac=c2030ad10f1ceb9b3307a43d40905c80454d3d289e9671c835d1b190fa6b8c36&w=1380)] bg-cover bg-right md:bg-center bg-no-repeat">
